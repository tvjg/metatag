...
var $FRAMES, $FRAMES_2_2, BaseError, BitPaddedInt, ByteSpec, COM, COMM, EOFError, EncodedNumericPartTextSpec, EncodedNumericTextSpec, EncodedTextSpec, EncodingSpec, FRAMES, FRAMES_2_2, Frame, ID3, ID3NoHeaderError, ID3TimeStamp, ID3UnsupportedVersionError, MultiSpec, NumericPartTextFrame, NumericTextFrame, ParseID3v1, Spec, StringSpec, TAL, TALB, TBP, TBPM, TCM, TCMP, TCO, TCOM, TCOP, TCR, TDA, TDAT, TDEN, TDOR, TDRC, TDRL, TDTG, TIM, TIME, TIT1, TIT2, TIT3, TLE, TLEN, TP1, TP2, TP3, TP4, TPA, TPE1, TPE2, TPE3, TPE4, TPOS, TRCK, TRK, TT1, TT2, TT3, TYE, TYER, TextFrame, TimeStampSpec, TimeStampTextFrame, cls, convert, fs, sprintf, _, _i, _j, _len, _len1,
