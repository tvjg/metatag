...
var $FRAMES, $FRAMES_2_2, BaseError, BitPaddedInt, ByteSpec, EOFError, EncodedNumericPartTextSpec, EncodedNumericTextSpec, EncodedTextSpec, EncodingSpec, FRAMES, FRAMES_2_2, Frame, ID3, ID3NoHeaderError, ID3UnsupportedVersionError, Iconv, MultiSpec, NumericPartTextFrame, NumericTextFrame, ParseID3v1, Spec, TAL, TALB, TBP, TBPM, TCM, TCMP, TCO, TCOM, TCOP, TCR, TDA, TDAT, TIM, TIME, TIT1, TIT2, TIT3, TLE, TLEN, TP1, TP2, TP3, TP4, TPA, TPE1, TPE2, TPE3, TPE4, TPOS, TRCK, TRK, TT1, TT2, TT3, TYE, TYER, TextFrame, cls, convertToString, fromLatin1ToString, fromUTF16BEToString, fromUTF16ToString, fromUTF8ToString, fs, latin1ToUTF8, utf16, utf16be, _, _i, _j, _len, _len1,
...
ParseID3v1 = function(buffer) {
  var album, artist, comment, fix, frames, hexString, offset, str, tag, tagByteLength, title, year, _ref;
