...
var BinaryDataSpec, ByteSpec, EncodedNumericPartTextSpec, EncodedNumericTextSpec, EncodedTextSpec, EncodingSpec, ID3TimeStamp, Latin1TextSpec, MultiSpec, Spec, StringSpec, TimeStampSpec, UnicodeDecodeError, ValueError, convert, isArray, isString, sprintf, _ref, _ref1, _ref2,
...
BinaryDataSpec = (function(_super) {
  __extends(BinaryDataSpec, _super);

  function BinaryDataSpec(name) {
    if (!(this instanceof BinaryDataSpec)) {
      return (function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(BinaryDataSpec, arguments, function(){});
    }
    BinaryDataSpec.__super__.constructor.call(this, name);
  }

  BinaryDataSpec.prototype.read = function(frame, data) {
    return [data, ''];
  };

  BinaryDataSpec.prototype.validate = function(frame, value) {
    return value.toString();
  };

  return BinaryDataSpec;
...
Latin1TextSpec = (function(_super) {
  __extends(Latin1TextSpec, _super);

  function Latin1TextSpec(name) {
    if (!(this instanceof Latin1TextSpec)) {
      return (function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(Latin1TextSpec, arguments, function(){});
    }
    Latin1TextSpec.__super__.constructor.call(this, name);
  }

  Latin1TextSpec.prototype.read = function(frame, data) {
    var hexArr, hexStr, offset, ret, stringOffset, _ref3;
    hexStr = data.toString('hex');
    ...
    if (offset !== -1) {
      ...
      _ref3 = [hexStr.slice(0, stringOffset), hexStr.slice(stringOffset + 2)], data = _ref3[0], ret = _ref3[1];
    }
    data = new Buffer(data, 'hex');
    ret = new Buffer(ret, 'hex');
  ...
  Latin1TextSpec.prototype.validate = function(frame, value) {
    return value;
  };

  return Latin1TextSpec;
