...
Frame = (function() {
  function Frame(fields) {
    var checker, validated, _i, _len, _ref;
...
EncodedTextSpec = (function(_super) {
  ...
  EncodedTextSpec.prototype.read = function(frame, data) {
    ...
    _ref = EncodedTextSpec._encodings[frame.encoding], encoding = _ref[0], term = _ref[1];
...
TCON = (function(_super) {
  ...
  TCON.prototype.__get_genres = function() {
    ...
    this.text.forEach(function(value) {
      var d, dummy, genreid, genrename, gid, gids, idx, newGenres, notDigits, wholematch, _ref6;
      notDigits = (function() {
        var _i, _len, _results;
        _results = [];
        for (_i = 0, _len = value.length; _i < _len; _i++) {
      ...
      if (value && notDigits.length === 0) {
        ...
        newGenres = [];
        _ref6 = value.match(genre_re), wholematch = _ref6[0], genreid = _ref6[1], dummy = _ref6[2], genrename = _ref6[3];
        if (genreid) {
          gids = (function() {
            var _i, _len, _ref7, _results;
            _ref7 = genreid.slice(1, -1).split(')(');
            _results = [];
...
$FRAMES_2_2 = [
  TAL = (function(_super) {
    ...
    function TCO() {
      _ref49 = TCO.__super__.constructor.apply(this, arguments);
      return _ref49;
    }
